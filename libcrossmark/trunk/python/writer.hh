...
public:
	...
	virtual void pushStyle (StyleType type) { crossmark::Writer::pushStyle ((crossmark::document::Style::Type) type); }
	virtual void popStyle (StyleType type) { crossmark::Writer::popStyle ((crossmark::document::Style::Type) type); }
